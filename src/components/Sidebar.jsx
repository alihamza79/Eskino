              ...
              <ul>
                ...
                <li className="submenu" >
                  <Link to="#" id="menu-item" onClick={(e) => {
                    ...
                    <span><Link className={props?.activeClassName === 'admin-dashboard' ? 'active' : ''} to="/admin-dashboard"> Dashboard </Link></span> 
                  </Link>
                ...
                <li className="submenu">
                  ...
                  <ul style={{ display: sidebar === 'Doctors' ? 'block' : 'none' }} className="menu-items1">
                    <li>
                      <Link className={props?.activeClassName === 'doctor-list' ? 'active' : ''} to="/meetinglist">Meeting List</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'add-doctor' ? 'active' : ''} to="/add-meeting">Add Meeting</Link>
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'edit-doctor' ? 'active' : ''} to="/editmeeting">Edit Meeting</Link>
                    </li>
                    <li>
                ...
                <li className="submenu">
                  ...
                  <ul style={{ display: "none" }} className="menu-items2">
                    <li>
                      <Link className={props?.activeClassName === 'participent-list' ? 'active' : ''} to="/participentlist">Participent List</Link>
                    </li>
                    <li>
                      {/* <Link className={props?.activeClassName === 'add-patient' ? 'active' : ''} to="/addpatients">Add Patients</Link> */}
                    </li>
                    <li>
                      <Link className={props?.activeClassName === 'edit-participent' ? 'active' : ''} to="/editparticipent">Edit Participent</Link>
                    </li>
                    <li>
