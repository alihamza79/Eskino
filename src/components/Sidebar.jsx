                ...
                <li className="submenu">
                  ...
                  <ul style={{ display: "none" }} className="menu-items7">
                    ...
                    <li>
                      <Link
                        className={
                          props?.activeClassName === "payments" ? "active" : ""
                        }
                        to="/payments"
                      >
                        Payments
                    ...
                    <li>
                      <Link
                        className={
                          props?.activeClassName === "expenses" ? "active" : ""
                        }
                        to="/expenses"
                      >
                        Expenses
                ...
                <li className="submenu">
                  ...
                  <ul style={{ display: "none" }} className="menu-items10">
                    ...
                    <li>
                      <Link
                        className={
                          props?.activeClassName === "mail-view" ? "active" : ""
                        }
                        to="/mail-view"
                      >
                        Mail View
                ...
                <li className="submenu">
                  ...
                  <ul style={{ display: "none" }} className="menu-items17">
                    ...
                    <li>
                      <Link
                        className={
                          props?.activeClassName === "register" ? "active" : ""
                        }
                        to="/register"
                      >
                        {" "}
                    ...
                    <li>
                      <Link
                        className={
                          props?.activeClassName === "404-error" ? "active" : ""
                        }
                        to="/error"
                      >
                        404 Error{" "}
                    ...
                    <li>
                      <Link
                        className={
                          props?.activeClassName === "500-error" ? "active" : ""
                        }
                        to="/server-error"
                      >
                        500 Error{" "}
